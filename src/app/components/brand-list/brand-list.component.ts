...
export class BrandListComponent implements OnInit {
  ...
  brands: any[] = [{name: "Tesla", logo: "tesla-logo.png"}, {
    name: "BMW",
    logo: "bmw-logo.png"
  ...
  }, {name: "RAM", logo: "ram-logo.png"}, {name: "Lada", logo: "lada-logo.png"}, {name: "Alpina", logo: "alpina-logo.png"}, {
    name: "Brabus",
    logo: "brabus-logo.png"
  }, {name: "Jetta", logo: "jetta-logo.png"}, {
    name: "MAN",
    logo: "man-logo.png"
  },{
    name: "Toyota Crown",
    logo: "toyota-crown-logo.png"
  }
  ];
